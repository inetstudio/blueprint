<div id="reg-check" class="reg-check">
    <div class="reg-check__wr">
        ...
        <form id="form-check-file" action="{{ route('front.checks-contest.checks.send') }}" method="post">
            {{ csrf_field() }}
            <div class="reg-check__body">
                ...
                <div class="reg-check__file-check">
                    ...
                    <input type="file" id="check-file" name="check_image" class="reg-check__file-file">
